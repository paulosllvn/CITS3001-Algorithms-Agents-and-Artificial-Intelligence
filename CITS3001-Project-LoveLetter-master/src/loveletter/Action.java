...
public class Action{
  ...
  public String toString(String player, String target){
    ...
    switch(card){
      ...
      case PRIEST: return "";
      case BARON: return "";
      case HANDMAID: return "";
      case PRINCE: return "";
      case KING: return "";
      case COUNTESS: return "";
  ...
  public static Action playGuard(int player, int target, Card guess) throws IllegalActionException{
    if(target==-1) throw new IllegalActionException("");
    if(player == target) throw new IllegalActionException("");
    if(guess == null) throw new IllegalActionException("");
    if(guess == Card.GUARD) throw new IllegalActionException("");
