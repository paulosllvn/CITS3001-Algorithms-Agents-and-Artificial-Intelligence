...
public class LoveLetter{
   ...
   * **/
  public LoveLetter(){
    this((int)(Math.random() * 50 + 1),System.out);
    this.ps = System.out;
  }
...
System.out.println("New Round, scores are:\nplayer 0:"+gameState.score(0)+"\nplayer 1:"+gameState.score(1)+"\nplayer 2:"+gameState.score(2)+"\nplayer 3:"+gameState.score(3));        
  ...
  public static void main(String[] args) {
      ...
      for (int j = 0; j < 1000; j++) {
          Agent[] agents = {new agents.BayesianAgent(),  new agents.Agent22112348(), new agents.Agent22112348(), new agents.Agent22112348()};
      ...
      System.out.println("Bayes 0 agent won " + countTest + "out of 1000 games");
      System.out.println("Knowledge 1 agent won " + countRand1 + "out of 1000 games");
      System.out.println("Random 2 agent won " + countRand2 + "out of 1000 games");
      System.out.println("Random 3 agent won " + countRand3 + "out of 1000 games");
